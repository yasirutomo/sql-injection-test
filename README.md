...
> Note: these five categories are a concise grouping commonly used in testing and literature; they correspond to well-known classifications such as In-band (UNION, Error), Inferential/Blind (Boolean, Time), and other variants. See the review paper referenced below for a thorough taxonomy (https://doi.org/10.1007/978-981-16-8059-5_35). The set is also used in (https://doi.org/10.63158/journalisi.v8i2.1475).